...
<head>
	<title>Financial Record - Barangay 455 DIMS</title>
...
<body>
	<div class="head"> 
		...
		<a href="#login-box" class="login-window" style="font-size: 12px; text-decoration:none; font-family:segoe UI; color: #fefcd7; position: fixed; right: 10px; top: 3px;" type="button">Login</a>
			<div id="login-box" class="login-popup">
				...
				<a href="fin1.php" style="text-decoration:none; font-family:bebas; padding:30px"><font size="3" color="#fefcd7">Cancel</font></a></center>
			</div>
		...
		<a href="#signup-box" class="signup-window" style="font-size: 12px; text-decoration:none; font-family:segoe UI; color: #fefcd7; position: fixed; right: 42px; top: 3px;" type="button">Signup  |</a>
			...
			<form method="post" class="signin" action="newaccount.php">
				...
				<hr width="320" noshade color="#71B238"></hr>
				<center><input type="image" src="images/ok.jpg" alt="submit" style="padding:0 50px 0 50px"></input><a href="fin1.php"><img src="images/cancel.png" style="padding:0 50px 0 50px"/></a></input></a>
			</form>
			</div>
			<script type="text/javascript" src="scripts/loginbutton.js"></script>
			<script type="text/javascript">
	...
	<div class="head4">
	<bodyheader>Financial Record</bodyheader>
	<desc style="top:-5px;left:7.5%;"><ul> Here is the financial report of disaster and non-disaster related expenses: </ul></desc>
	</div>
...
<div id="accordion">
	...
	<div class="pane" style="overflow:auto">
		...
		<tr>
			<th width=\"270px\">Name</th><th width=\"295px\">Cost</th><th width=\"295px\">Denum</th><th>Total</th>
		</tr>";
...
<!-- get from db 
	<?php
		...
		$result = mysql_query("SELECT * FROM fin");
		echo "<br><br><br><center>ITEMS</center><br><br><br>";
		echo "<table class=\"hovertable\" border=\"0\" style=\"padding: 0px 92px 100px 92px\">
		<tr>
			<th width=\"270px\">Name</th><th width=\"295px\">Cost</th><th width=\"295px\">Denum</th><th>Total</th>
		</tr>";
		...
		$result1 = mysql_query("SELECT * FROM findims");
		echo "<br><br><br><center>DIMS</center><br><br><br>";
		echo "<table class=\"hovertable\" border=\"1\" style=\"padding: 0px 92px 100px 92px\">
		<tr>
			<th width=\"270px\">Name</th><th width=\"295px\">Cost</th><th width=\"295px\">Denum</th><th>Total</th>
		</tr>";
