...
<body>
	...
	<div class="head"> 
		...
		<a href="#login-box" class="login-window" style="font-size: 12px; text-decoration:none; font-family:segoe UI; color: #fefcd7; position: fixed; right: 10px; top: 3px;" type="button">Login</a>
			<div id="login-box" class="login-popup">
				...
				<a href="residents1_g.php" style="text-decoration:none; font-family:bebas; padding:30px"><font size="3" color="#fefcd7">Cancel</font></a></center>
			</div>
		...
		<a href="#signup-box" class="signup-window" style="font-size: 12px; text-decoration:none; font-family:segoe UI; color: #fefcd7; position: fixed; right: 42px; top: 3px;" type="button">Signup  |</a>
			...
			<form method="post" class="signin" action="newaccount.php">
				...
				<hr width="320" noshade color="#71B238"></hr>
				<center><input type="image" src="images/ok.jpg" alt="submit" style="padding:0 50px 0 50px"></input><a href="residents1_g.php"><img src="images/cancel.png" style="padding:0 50px 0 50px"/></a></input></a>
			</form>
			</div>
			<script type="text/javascript" src="scripts/loginbutton.js"></script>
			<script type="text/javascript">
	...
	<a href="residents1_g.php" style="position:relative;top:-39px;left:805px;font-family:bebas;color:#a7dc6b;padding:0 0 3px 0;">G</a>
	...
	<?php
		...
		$result = mysql_query("SELECT * FROM residents WHERE lastname LIKE 'B%' ORDER BY lastname ASC ");
