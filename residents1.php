...
<body>
	...
	<div class="head"> 
		...
		<a href="#login-box" class="login-window" style="font-size: 12px; text-decoration:none; font-family:segoe UI; color: #fefcd7; position: fixed; right: 10px; top: 3px;" type="button">Login</a>
			<div id="login-box" class="login-popup">
				...
				<a href="residents1.php" style="text-decoration:none; font-family:bebas; padding:30px"><font size="3" color="#fefcd7">Cancel</font></a></center>
			</div>
		...
		<a href="#signup-box" class="signup-window" style="font-size: 12px; text-decoration:none; font-family:Segoe UI; color: #fefcd7; position: fixed; right: 42px; top: 3px;" type="button">Signup  |</a>
			...
			<form method="post" class="signin" action="newaccount.php">
				...
				<hr width="320" noshade color="#71B238"></hr>
				<center><input type="image" src="images/ok.jpg" alt="submit" style="padding:0 50px 0 50px"></input><a href="residents1.php"><img src="images/cancel.png" style="padding:0 50px 0 50px"/></a></input></a>
			</form>
			</div>
			<script type="text/javascript" src="scripts/loginbutton.js"></script>
			<script type="text/javascript">
	...
	<a href="residents1_h.php" style="position:relative;top:-39px;left:810px;font-family:bebas;color:#000;padding:0 0 3px 0;">H</a>
	...
	<?php
		...
		<tr>
			<th width=\"180px\">Last Name</th><th width=\"190px\">First Name</th><th width=\"180px\">Middle Name</th><th width=\"90px\">Gender</th><th>Telephone Number</th><th>Mobile Number</th><th width=\"100px\">House Num</th><th width=\"210px\">Street Name</th><th width=\"170px\">Brgy</th><th width=\"140px\">District</th><th width=\"150px\">City</th>
		</tr>";
