...
<BODY>
	...
	<div class="head"> 
		...
		<a href="#" class="close"><img src="images/websover_x.jpg" class="btn_close" title="Close Window" alt="Close" /></a>
			<form method="post" class="signin" action="insertresident.php" onsubmit="return validateForm(this);">
				...
				<label class="birth" style="padding:1px 1px 1px; font-color:'#FFFFFF'; font-family:'Segoe UI';">
	...
	<div class="head4" style="left:-12px;top:140px;margin: -13px 0 -20px 0;">
	<bodyheader>Edit Registered Residents</bodyheader>
	</div>
	
	<div class="head3" style="height:100px; left:115px;top:190px; background-color:#fefcd7;">
	<div class="success">You have successfully updated the database.</div><br>
	<div class="editbar">
	...
	<a href="#addresident-box" class="addresident-window addeventbutton" style="height: 30px; width: 30px; position: relative; left: 750px; top: -8px;"><img src="images/addres.png"></a>	
	</div>
	...
	<?php
		...
		<tr>
			<th width=\"110px\">Cedula Number</th><th width=\"180px\">Last Name</th><th width=\"190px\">First Name</th><th width=\"180px\">Middle Name</th><th width=\"85px\">Birth Month</th><th width=\"85px\">Birth Day</th><th width=\"85px\">Birth Year</th><th width=\"100px\">House Num</th><th width=\"210px\">Street Name</th><th width=\"170px\">Barangay</th><th width=\"140px\">District</th><th width=\"150px\">City</th><th colspan=\"2\">OPTIONS</th>
		</tr>";
