...
<BODY>
	...
	<div class="head"> 
		...
		<a href="#login-box" class="login-window" style="font-size: 12px; text-decoration:none; font face=verdana; color: #fefcd7; position: fixed; right: 10px; top: 3px;" type="button">Login</a>
			<div id="login-box" class="login-popup">
				...
				<a href="inventory1_assets_p.php" style="text-decoration:none; font-family:bebas; padding:30px"><font size="3" color="#fefcd7">Cancel</font></a></center>
			</div>
		...
		<a href="#signup-box" class="signup-window" style="font-size: 12px; text-decoration:none; font face=verdana; color: #fefcd7; position: fixed; right: 42px; top: 3px;" type="button">Signup  |</a>
			...
			<form method="post" class="signin" action="newaccount.php">
				...
				<hr width="320" noshade color="#71B238"></hr>
				<center><input type="image" src="images/ok.jpg" alt="submit" style="padding:0 50px 0 50px"></input><a href="inventory1_assets_p.php"><img src="images/cancel.png" style="padding:0 50px 0 50px"/></a></input></a>
			</form>
			</div>
			<script type="text/javascript" src="scripts/loginbutton.js"></script>
			<script type="text/javascript">
	...
	<div class="head4">
	<bodyheader style="left:7.5%px;">Inventory - Assets</bodyheader>
	<desc style="top:-5px;left:7.5%;"><ul> The following table contains the long-term assets the barangay owns as of March 2013: </ul></desc>
	<a href="#" style="position:fixed;top:165px;left:755px;font-family:bebas;"><img src="images/search.png">
	<a href="inventory1_asset_a.php" onclick="showbyletter();" style="position:relative;top:-39px;left:775px;font-family:bebas;color:#000;padding:0 0 3px 0;">A</a>
	<a href="inventory1_asset_b.php" style="position:relative;top:-39px;left:780px;font-family:bebas;color:#000;padding:0 0 3px 0;">B</a>
	<a href="inventory1_asset_c.php" style="position:relative;top:-39px;left:785px;font-family:bebas;color:#000;padding:0 0 3px 0;">C</a>
	<a href="inventory1_asset_d.php" style="position:relative;top:-39px;left:790px;font-family:bebas;color:#000;padding:0 0 3px 0;">D</a>
	<a href="inventory1_asset_e.php" style="position:relative;top:-39px;left:795px;font-family:bebas;color:#000;padding:0 0 3px 0;">E</a>
	<a href="inventory1_asset_f.php" style="position:relative;top:-39px;left:800px;font-family:bebas;color:#000;padding:0 0 3px 0;">F</a>
	...
	<a href="inventory1_asset_p.php" style="position:relative;top:-39px;left:850px;font-family:bebas;color:#a7dc6b;padding:0 0 3px 0;">P</a>
	...
	<?php
		...
		$result = mysql_query("SELECT * FROM assets WHERE name LIKE 'P%' ORDER BY name asc");
