...
<HEAD>
<TITLE>Edit Materials - Barangay 455 DIMS</TITLE>
...
<BODY>
	...
	<div class="head3" style="height:175px; top:200px;">
	...
	$res_id = $_GET['id'];
	$res = mysql_query("select * from materials where id = '".$res_id."'");
	$row = mysql_fetch_assoc($res);

	echo"<form method=\"post\" action=\"savemat.php?id=".$res_id."\" onsubmit=\"return validateForm(this);\">
		<fieldset class=\"textbox\">
				...
				<a href=\"inventory2_materials.php\"><input type=\"button\" name=\"cancel\" value=\"Cancel\" /></a>
				</center>
				</fieldset>
		</form>";
