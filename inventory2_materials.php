...
<script type="text/javascript" src="scripts/formvalidate_mat.js"></script>
</HEAD>
...
<BODY>
	...
	<div class="head"> 
		...
		<!--add item popup-->
		<div id="addmat-box" class="addmat-popup">
		<a href="#" class="close"><img src="images/websover_x.jpg" class="btn_close" title="Close Window" alt="Close" /></a>
			<form method="post" class="signin" action="insertmat.php" onsubmit="return validateForm(this);">
				...
				<label class="pic" style="padding:1px 1px 1px; font-color:'#FFFFFF'; font-family:'Segoe UI';">
					<span>Name of Person/Committee In Charge of Material</span>
				</label>		
				...
				<label class="pic_contact" style="padding:1px 1px 1px; font-color:'#FFFFFF'; font-family:'Segoe UI';">
					<span>Contact of Person/Committee In Charge of Material</span>
				</label>	
	...
	<script type="text/javascript">
			$(document).ready(function() {
				$('a.addmat-window').click(function() {
				...
				$('a.close, #mask').live('click', function() { 
				  $('#mask , .addmat-popup').fadeOut(300 , function() {
					$('#mask').remove();  
				}); 
				return false;
				});
	...
	<!-- Logout button start-->
		<div class="wrap">
			...
			<div id="login-box" class="login-popup">
				...
				<br>
				<br>
				<center><a href="main1.php"><img src="images/yes.png" style="padding:0 50px 0 50px"/></a></input></a><a href="inventory2_materials.php"><img src="images/no.png" style="padding:0 50px 0 50px"/></a></input></a>
			</div>
			<script type="text/javascript" src="scripts/loginbutton.js"></script>
			<script type="text/javascript">
				$(document).ready(function() {
	...
	<bodyheader>Edit Inventory - Materials</bodyheader>
	</div>
	...
	<a href="#addmat-box" class="addmat-window addeventbutton" style="height: 30px; width: 30px; position: relative; left: 708px; top: -13px;"><img src="images/addres.png"></a>	
	</div>
	...
	<?php
		...
		$result = mysql_query("SELECT * FROM materials ORDER BY name asc");

		echo "<table class=\"hovertable\" border=\"1\">
		<tr>
			<th width=\"220px\">Name</th><th width=\"60px\">Amount</th><th colspan=\"2\" width=\"350px\">Person/Committee In Charge</th><th width=\"235px\">Description (if available)</th><th colspan=\"2\">Options</th>
		</tr>";
		...
		while($row = mysql_fetch_array($result)) {
			...
			echo "<td>" . $row['desc'] . "</td>";
			echo "<td><a href=\"editmat.php?id=".$row['id']."\" style=\"position: relative;\"><img src=\"images/btn_edit.png\"></a></td>";
			echo "<td><form action=\"deletemat.php\" method=\"post\" onsubmit=\"return confirmDelete();\">
