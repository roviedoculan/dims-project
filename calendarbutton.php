...
<body>
	...
	<form method="post" class="signin" action="addactivity.php">
		<font color="#fefcd7" style="font-family:bebas">ADD ACTIVITY</font>
		<hr width="320" noshade color="#71B238"></hr>
		<font type="text" size="2" color="#fefcd7" style="font-family:verdana; padding:5px">Title:</font>
		<br>
		<center><input name="activitytitle" style="width:90%"></input></center>
		<font size="2" color="#fefcd7" style="font-family:verdana; padding:5px">Description:</font>
		<br>
		<center><textarea name="activitydescription" rows="5" style="width:90%; font-family:verdana;"></textarea></center>
		<font size="2" color="#fefcd7" style="font-family:verdana; padding:5px">Duration:</font>
		<?php $monthNames = Array("January","February","March","April","May","June","July","August","September","October","November","December"); $Cmonth=$_SESSION['Cmonth']; echo "<font size=\"1\" color=\"#fefcd7\" style=\"font-family:verdana; padding:2px\">".$monthNames[$Cmonth]."</font>"; ?> <input type="text" name="activitydate1" style="width:20"></input> <font size="1" color="#fefcd7" style="font-family:verdana; padding:2px"> to </font> <input type="text" name="activitydate2" style="width:20"></input> <?php $Cyear=$_SESSION['Cyear']; echo "<font size=\"1\" color=\"#fefcd7\" style=\"font-family:verdana; padding:2px\">,".$Cyear."</font>"; ?>
		<hr width="320" noshade color="71B238"></hr>
