...
$pdf->SetY(20);
$pdf->Cell(0,10,'Inventory: Materials', 0,0,'C');
...
$header = array('Name', 'Amount', 'Description','Person-In-Charge (PIC)', 'PIC Contact Info');
$w = array(50, 20, 120, 45, 40);
